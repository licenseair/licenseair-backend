...
import com.licenseair.dashboard.commons.auth.JwtAuthError;
import com.licenseair.dashboard.commons.auth.JwtAuthFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(JwtAuthError myAuthErrorHandler) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
          ...
          .authorizeRequests()
          // 需要登录
          .antMatchers("/pay/get-form").authenticated()
